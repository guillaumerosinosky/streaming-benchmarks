...
function kafka_setup() {
    ...
    sed -i "/advertised.listeners/c\advertised.listeners=PLAINTEXT://${HOSTNAME: -1}:9092,PLAINTEXT_HOST://localhost:19092" /root/streaming-benchmarks/"${KAFKA_DIR}"/config/server.properties
}
