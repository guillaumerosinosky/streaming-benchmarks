...
source('~/Desktop/EDU/THESIS/streaming-benchmarks/reporting/StreamServerReport.r')
source('~/Desktop/EDU/THESIS/streaming-benchmarks/reporting/KafkaServerReport.r')
source('~/Desktop/EDU/THESIS/streaming-benchmarks/reporting/BenchmarkResult.r')
source('~/Desktop/EDU/THESIS/streaming-benchmarks/reporting/BenchmarkPercentile.R')
source('~/Desktop/EDU/THESIS/streaming-benchmarks/reporting/ResourceConsumptionReport.r')
